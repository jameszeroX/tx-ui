...
#    echo -e "${green}bash <(curl -Ls https://raw.githubusercontent.com/AghayeCoder/tx-ui/master/install.sh)${plain}"
    echo -e "${green}bash <(curl -Ls https://raw.githubusercontent.com/jameszeroX/tx-ui/master/install.sh)${plain}"
    echo ""
...
#    wget -O /usr/bin/x-ui -N --no-check-certificate https://github.com/AghayeCoder/tx-ui/raw/main/x-ui.sh
    wget -O /usr/bin/x-ui -N --no-check-certificate https://github.com/jameszeroX/tx-ui/raw/main/x-ui.sh
    if [[ $? != 0 ]]; then
        echo ""
